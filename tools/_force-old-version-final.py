...
# Substitui TODAS as ocorrências de 0.2.17 por 0.2.15 em content=
import re
data = re.sub(r'content="0\.2\.\d+"', 'content="0.2.15"', data)
open(idx_path, 'w', encoding='utf-8').write(data)
print('index.html -> 0.2.15 (todos os metas)')
